...
public class FreshDownloadView extends View {
    ...
    public static final int ANIMATION_UP_DURATION = 300;
    ...
    private AnimatorSet getPrepareAnimator() {
        ...
        ValueAnimator downAnimaor = ValueAnimator.ofFloat(0f, 0.3f, 0f).setDuration(ANIMATION_DOWN_DURATION);
        ...
        ValueAnimator upAnimator = ValueAnimator.ofFloat(0f, 1f).setDuration(ANIMATION_UP_DURATION);
    ...
    private AnimatorSet getDownloadOkAnimator() {
        ...
        ValueAnimator secondAnimator = ValueAnimator.ofFloat(0f, 0.35f, 0.2f).setDuration(300);
    ...
    private AnimatorSet getDownLoadErrorAnimator() {
        ...
        ValueAnimator animator1 = ValueAnimator.ofFloat(0.2f, 0.8f).setDuration(ANIMATION_DURATION);
        ...
        ValueAnimator animator2 = ValueAnimator.ofFloat(0.2f, 0.8f).setDuration(ANIMATION_DURATION);
